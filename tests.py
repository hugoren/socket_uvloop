...
# a = dataBuffer.endswith(start=b'{"@timestamp"', end=b"\n")
# print(a)


# from flashtext.keyword import KeywordProcessor
# k = KeywordProcessor()
# k.add_keyword('{"@timestamp"')
# k.add_keyword("2018")
# k_found = k.extract_keywords(str(dataBuffer))
# print(k_found)
...
c = '{"message":"\\u7EA2\\u5305\\u57CB\\u70B9"}\n{"fdsafas}'
match_pattern = re.compile(r'^{".?"}$', flags=re.DOTALL)
r = match_pattern.findall(str(dataBuffer))
print(r)